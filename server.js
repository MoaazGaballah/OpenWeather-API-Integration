...
// we will serve static pages from the public directory, it will act as root directory
    ...
    request(url, function(err, response, body) {
        ...
        if (err) {
            ...
            if (weather.main == undefined) {
                ...
                // we shall use the data got to set up output
                ...
                // you shall now render the data to page (index.ejs) before displaying it out
                res.render("index", {
                    weather: weather,
                    place: place,
                    temp: weatherTemp,
...
// set up port configurations. You will also start the server and add a message to display when running.
